...
from shark.collective.const import ENV
from shark.collective.collective_group import nccl_util
from shark.collective.collective_group.base_collective_group import BaseGroup
from shark.collective.const import get_store_name
from shark.collective.types import (AllReduceOptions, BarrierOptions, Backend,
                                   ReduceOptions, BroadcastOptions,
                                   AllGatherOptions, ReduceScatterOptions,
                                   SendOptions, RecvOptions)
from shark.collective.collective_group.cuda_stream import get_stream_pool
...
class NCCLGroup(BaseGroup):
    ...
    def _get_nccl_p2p_communicator(self,
        ...
        if self.rank < peer_rank:
            ...
            raise RuntimeError(
                ...
                "shark.collective does not support this case as of now. "
    ...
    def _generate_nccl_uid(key):
        ...
        from shark.collective.util import NCCLUniqueIDStore  # pylint: disable=import-outside-toplevel
...
def _get_comm_key_send_recv(my_rank, my_gpu_idx, peer_rank, peer_gpu_idx):
    ...
    if my_rank < peer_rank:
        ...
        raise RuntimeError(
            "Send and recv happens on the same process. shark.collective "
