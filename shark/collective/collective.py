...
import numpy as np
import ray
from shark.collective import types
...
try:
    from shark.collective.collective_group.nccl_collective_group import (
        NCCLGroup)
except ImportError:
...
try:
    from shark.collective.collective_group.gloo_collective_group import (
        GLOOGroup)
except ImportError:
...
def create_collective_group(actors,
    ...
    from shark.collective.util import Info  # pylint: disable=import-outside-toplevel
